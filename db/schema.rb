...
ActiveRecord::Schema.define(version: 20151211232648) do
  ...
  add_index "invites", ["user_id", "game_id"], name: "index_invites_on_user_id_and_game_id", unique: true, using: :btree
